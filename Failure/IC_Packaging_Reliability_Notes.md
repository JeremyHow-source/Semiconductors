...
- **[Ch.2]** Metal enclosure materials — Table 2.2: *(2026-06-25)*
  ...
  > ⚠️ *Placeholder values — please verify against Table 2.2 in the source document.*
...
- **[Ch.2]** Table 2.3 — Coefficient of Thermal Expansion (CTE) for typical package materials: *(2026-06-25)*
  ...
  > ⚠️ *Placeholder values — please verify against Table 2.3 in the source document.*
